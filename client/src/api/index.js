...
export const authSignup = (data) => API.post(`${USER_BASEURL}/signup`, data, { headers: { 'Content-Type': 'application/json' } });
...
export const processPayment = (products, token, data) => API.post(`${PAYMENTS_BASEURL}`, { products, token, data },
    {
        headers: {
